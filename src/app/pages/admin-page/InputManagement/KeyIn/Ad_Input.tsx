...
const columns: ColumnDef<Input>[] = [
  ...
  { accessorKey: '1월', header: () => <div style={{ textAlign: 'center' }}>1월 (kg)</div>, cell: info => numeral(info.getValue()).format('0,0') },
  { accessorKey: '2월', header: () => <div style={{ textAlign: 'center' }}>2월 (kg)</div>, cell: info => numeral(info.getValue()).format('0,0') },
  { accessorKey: '3월', header: () => <div style={{ textAlign: 'center' }}>3월 (kg)</div>, cell: info => numeral(info.getValue()).format('0,0') },
  { accessorKey: '4월', header: () => <div style={{ textAlign: 'center' }}>4월 (kg)</div>, cell: info => numeral(info.getValue()).format('0,0') },
  { accessorKey: '5월', header: () => <div style={{ textAlign: 'center' }}>5월 (kg)</div>, cell: info => numeral(info.getValue()).format('0,0') },
  { accessorKey: '6월', header: () => <div style={{ textAlign: 'center' }}>6월 (kg)</div>, cell: info => numeral(info.getValue()).format('0,0') },
  { accessorKey: '7월', header: () => <div style={{ textAlign: 'center' }}>7월 (kg)</div>, cell: info => numeral(info.getValue()).format('0,0') },
  { accessorKey: '8월', header: () => <div style={{ textAlign: 'center' }}>8월 (kg)</div>, cell: info => numeral(info.getValue()).format('0,0') },
  { accessorKey: '9월', header: () => <div style={{ textAlign: 'center' }}>9월 (kg)</div>, cell: info => numeral(info.getValue()).format('0,0') },
  { accessorKey: '10월', header: () => <div style={{ textAlign: 'center' }}>10월 (kg)</div>, cell: info => numeral(info.getValue()).format('0,0') },
  { accessorKey: '11월', header: () => <div style={{ textAlign: 'center' }}>11월 (kg)</div>, cell: info => numeral(info.getValue()).format('0,0') },
  { accessorKey: '12월', header: () => <div style={{ textAlign: 'center' }}>12월 (kg)</div>, cell: info => numeral(info.getValue()).format('0,0') },
];
