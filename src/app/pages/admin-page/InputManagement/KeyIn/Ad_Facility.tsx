        ...
        <Box sx={modalStyle2}>
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12}>
              ...
              />
              <Typography variant="body2" color="textSecondary" style={{ fontSize: '12px', marginTop: '2px', marginLeft: '20px', color: 'black'}}>
                전기를 사용하는 주요 설비명을 기재해 주세요. (예시 : 파쇄시설, 분쇄시설, 자력선별시설, 근적외선선별시설, 중력선별시설, 성형시설, 냉매회수시설 등)
              </Typography>
              <Typography variant="body2" color="textSecondary" style={{ fontSize: '12px', marginTop: '2px', marginLeft: '20px', color: 'red'}}>
