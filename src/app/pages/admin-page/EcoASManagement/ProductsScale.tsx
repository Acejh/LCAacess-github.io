...
export function ProductsScale() {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
        const url = `https://lcaapi.acess.co.kr/ScaledItemWeights/monthly?CompanyCode=${searchParams.company.code}&Year=${searchParams.year}`;
                      ...
                      {row.getVisibleCells().map(cell => (
                        <TableCell 
                          ...
                          style={{ 
                            ...
                            overflow: 'hidden', 
                            textOverflow: 'ellipsis', 
                            textAlign: ['categoryName', 'midItemName', 'itemName'].includes(cell.column.id) ? 'left' : 'right', 
                          }}>
