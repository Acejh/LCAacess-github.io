      ...
      <div id='kt_account_profile_details' className='collapse show'>
        <form onSubmit={formik.handleSubmit} noValidate className='form'>
          <div className='card-body border-top p-9'>
            ...
            <div className='row mb-6'>
              <label className='col-lg-4 col-form-label required fw-bold fs-6'>회사</label>
            ...
            <div className='row mb-6'>
              <label className='col-lg-4 col-form-label fw-bold fs-6'>
                <span className='required'>회사 사이트</span>
              </label>
            ...
            <div className='row mb-6'>
              <label className='col-lg-4 col-form-label fw-bold fs-6'>
                <span className='required'>나라</span>
              </label>
            ...
            <div className='row mb-6'>
              <label className='col-lg-4 col-form-label required fw-bold fs-6'>언어</label>
              <div className='col-lg-8 fv-row'>
                <select
            ...
            <div className='row mb-6'>
              <label className='col-lg-4 col-form-label required fw-bold fs-6'>시간</label>
            ...
            <div className='row mb-6'>
              <label className='col-lg-4 col-form-label required fw-bold fs-6'>화폐</label>
            ...
            <div className='row mb-6'>
              <label className='col-lg-4 col-form-label fw-bold fs-6'>연락수단</label>
            ...
            <div className='row mb-0'>
              <label className='col-lg-4 col-form-label fw-bold fs-6'>test</label>
